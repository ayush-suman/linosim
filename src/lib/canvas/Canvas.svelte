...
<canvas bind:this={canvas} {width} {height} on:mousedown={handlers.onMouseDown} on:mousemove={handlers.onMouseMove} on:mouseup={handlers.onMouseUp} on:scroll={handlers.onScroll}>
